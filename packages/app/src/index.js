...
const signature = facade.signTransaction(new symbolSdk.symbol.KeyPair(privateKey), transaction);
console.log(privateKey.toString());
console.log(signature.toString());
const jsonPayload = symbolSdk.symbol.TransactionFactory.attachSignature(transaction, signature);
